...
/*const reply = (teks) => {
			memz.sendMessage(from, teks, text, { thumbnail: iye, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jam} - ${week} ${weton} - ${date}`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/14842842183?text=hello`}}})
		}*/
...
memz.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
    ...
    const add = function (from, orangnya) {
      memz.groupAdd(from, orangnya);
        ...
        const grupinv = (teks) => {
        	grup = memz.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `memz Bot Inc.`, "footerText": "*_𝐃𝐨𝐠𝐞 𝐁𝐨𝐭_*", "jpegThumbnail": iye, "caption": teks}}, {quoted:mek})
...
// Katalog
const reply = (teks) => {
             res = memz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 111119999, "message": teks, "footerText": "*memz*", "thumbnail": bgg, "surface": 'CATALOG' }}, {quoted:ftrol})
             memz.relayWAMessage(res)
        }
const fakewa = (teks) => {        
memz.sendMessage(from, teks, text, { thumbnail: fake, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `memz`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/14842842183?text=hello`}}})
		}
...
"externalAdReply": {
                "title": `Whatsapp`,
                "body": `wa.me/14842842183`,
                "mediaType": "10",
                "mediaUrl": `wa.me/14842842183`,
                "thumbnailUrl": "https://i.ibb.co/y0RYgzB/FB-IMG-1635413002830.jpg",
                "thumbnail": iye,
                "sourceUrl": `wa.me/14842842183`,
...
await memz.setStatus(`Bot Mode On Since ${uptime}`).catch((_) => _);
...
case 'bugreport':
              ...
              memz.sendMessage('916909137213@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
...
case 'iggw':
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
  reply('https://www.instagram.com/josephmemz13/')
break
...
case 'script':
		case 'sc':
		case 'sourcecode':
		memz.sendMessage(from, { text: "https://github.com/DGmemz/            memz                                                                                                            Bot", matchedText: 'nopee', description: "", title: "What are you doing?", jpegThumbnail: iye }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
      //------------------< Sticker Cmd >-------------------
      case "addcmd":
      case "setcmd":
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          ...
          "url": "https://github.com/DGmemz/            memz                                                                                                            Bot"
        },
        "index": 0
      }
    ]
   ...
   case 'bc':
      case 'broadcast':
        if (!mek.key.fromMe) return;
             ...
             for (let _ of anu) {
             memz.sendMessage(_.jid, bc, image, {quoted:fkontak,caption: `*「 𝐃𝐨𝐠𝐞 𝐁𝐨𝐭 BROADCASTING 」*\n\n${body.slice(4)}`})
}
...
case 'attp':
              ...
              break
				...
				anu = await fetchJson(`https://bx-hunter.herokuapp.com/api/resepmakanan?query=${teks}&apikey=${HunterApi}`, {method: 'get'})
					...
					memz.sendMessage(from, buff, image, {quoted: ftok, caption: hasilresep})
					break 
					case 'githubstalk':
